...
bool UICredits::init()
{
    ...
    auto configLabel = Label::createWithTTF(LocalizedString::create("CREDITS"), "fonts/BebasNeue.otf", 200 * GameData::getInstance()->getRaConversion());
    ...
    auto programmerLabel = Label::createWithTTF(LocalizedString::create("PROGRAMMER"), "fonts/BebasNeue.otf", 160 * GameData::getInstance()->getRaConversion());
    ...
    auto xpLabel = Label::createWithTTF("Xavier Rubio", "fonts/BebasNeue.otf", 90 * GameData::getInstance()->getRaConversion());
    ...
    auto gpLabel = Label::createWithTTF("Guillem Laborda", "fonts/BebasNeue.otf", 90 * GameData::getInstance()->getRaConversion());
    ...
    auto designerLabel = Label::createWithTTF(LocalizedString::create("GRAPHIC_DESIGNER"), "fonts/BebasNeue.otf", 160 * GameData::getInstance()->getRaConversion());
    ...
    auto gdLabel = Label::createWithTTF("Guillem H. Pongiluppi", "fonts/BebasNeue.otf", 90 * GameData::getInstance()->getRaConversion());
    ...
    auto ddLabel = Label::createWithTTF("David Ramos", "fonts/BebasNeue.otf", 90 * GameData::getInstance()->getRaConversion());
    ...
    auto musicLabel = Label::createWithTTF(LocalizedString::create("MUSIC_AND_SFX"), "fonts/BebasNeue.otf", 160 * GameData::getInstance()->getRaConversion());
    ...
    auto gsLabel = Label::createWithTTF("Guillem Laborda", "fonts/BebasNeue.otf", 90 * GameData::getInstance()->getRaConversion());
    ...
    auto contentLabel = Label::createWithTTF(LocalizedString::create("CONTENT_AND_STORY"), "fonts/BebasNeue.otf", 160 * GameData::getInstance()->getRaConversion());
    ...
    auto jcLabel = Label::createWithTTF("Jorge Caro", "fonts/BebasNeue.otf", 90 * GameData::getInstance()->getRaConversion());
    ...
    auto xcLabel = Label::createWithTTF("Xavier Rubio", "fonts/BebasNeue.otf", 90 * GameData::getInstance()->getRaConversion());
    ...
    auto directorLabel = Label::createWithTTF(LocalizedString::create("DIRECTOR_AND_SLAVER"), "fonts/BebasNeue.otf", 160 * GameData::getInstance()->getRaConversion());
    ...
    auto xdLabel = Label::createWithTTF("Xavier Rubio", "fonts/BebasNeue.otf", 90 * GameData::getInstance()->getRaConversion());
