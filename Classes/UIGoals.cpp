...
bool UIGoals::init()
{
    ...
    auto contextLabelIntroduction = Label::createWithTTF(LocalizedString::create("CONTEXT_TITLE_INTRO"),
                                                         "fonts/BebasNeue.otf", 200 * GameData::getInstance()->getRaConversion());
    ...
    auto startPlay = Label::createWithTTF(LocalizedString::create("START"), "fonts/BebasNeue.otf", 90 * GameData::getInstance()->getRaConversion());
...
void UIGoals::setLevelGoals(Layout* layout)
{
    ...
    {
        //ATRIBUT MODIFICABLE
        auto attLabel = Label::createWithTTF(LocalizedString::create(GameLevel::getInstance()->convertAttIntToString(GameLevel::getInstance()->getModifiableAttr().at(i)).c_str()) + ":    Explicació de l'atribut", "fonts/BebasNeue.otf", 120 * GameData::getInstance()->getRaConversion());
    ...
    auto powersLabel = Label::createWithTTF(LocalizedString::create("POWERS"), "fonts/BebasNeue.otf", 160 * GameData::getInstance()->getRaConversion());
    ...
    {
        auto powersNotAvailableLabel = Label::createWithTTF(LocalizedString::create("NOT_AVAILABLE"), "fonts/BebasNeue.otf", 160 * GameData::getInstance()->getRaConversion());
