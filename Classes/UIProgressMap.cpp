...
bool UIProgressMap::init()
{
    ...
    auto eraLabel = Label::createWithTTF(LocalizedString::create("FIRST")+" "+LocalizedString::create("ERA"), "fonts/BebasNeue.otf", 80 * GameData::getInstance()->getRaConversion());
...
void UIProgressMap::menuLevelCallback(Ref* pSender)
{
    ...
    auto briefText = TextFieldTTF::textFieldWithPlaceHolder(LocalizedString::create(("BRIEF_LEVEL_" + to_string(tag)).c_str(), "text"),
        ...
        TextHAlignment::LEFT, "Arial Rounded MT Bold", 28 * GameData::getInstance()->getRaConversion());
    ...
    auto labelPlay = Label::createWithTTF(LocalizedString::create("PLAY"), "fonts/BebasNeue.otf", 50 * GameData::getInstance()->getRaConversion());
