...
bool MainMenu::init()
{
    ...
    cocos2d::MenuItem* pStartItem = cocos2d::MenuItemImage::create(
        "StartButton.png",
        "StartButtonPressed.png",
        this,
        menu_selector(MainMenu::menuPauseCallback));
    pStartItem->setPosition(Vec2(origin.x + visibleSize.width / 2,
                                 origin.y + visibleSize.height - (origin.y + visibleSize.height / 2)));
    this->addChild(pStartItem, 1);
